...
App.Views.HistPlot = Backbone.View.extend({
	...
	render: function() {
		...
		var statCode = '<div class="statistics"> mode fr = ' + this.model.get("mode_fr") + '</div>'; // code for statistics by data on plot
...
$(document).ready(function() {
	...
	var my_router = new App.Routers.MyRout(); // declare router
	Backbone.history.start();                 // run HTML5 History push 
